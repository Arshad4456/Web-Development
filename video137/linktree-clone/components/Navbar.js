...
const Navbar = () => {
  return (
    <>
    <nav className='bg-white flex w-[90%] mx-auto justify-between items-center px-4 py-4 rounded-full fixed top-10 right-[5%]'>
    <div className='flex gap-10 pl-6 items-center justify-center'>
    <div className='flex justify-center items-center'>
        <img className="nav-desktop-logo w-28" loading="eager" src="https://cdn.prod.website-files.com/666255f7f2126f4e8cec6f8f/66634daccb34e6d65a41c76d_download.svg" alt=""></img>
    </div>
