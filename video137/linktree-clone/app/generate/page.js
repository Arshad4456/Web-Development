...
const Generate = () => {
    ...
    return (
        <div className='grid grid-cols-2 min-h-[120vh] bg-[#E9C0E9] pt-12'>
            <div className=' col1 flex flex-col justify-center mx-auto'>
                ...
                <div className='flex flex-col'>
                    <h2 className='font-semibold text-lg mb-2'>Step 3: Add Picture and Description</h2>
                    ...
                    <input value={desc || ""} onChange={e=>{setdesc(e.target.value)}} className='focus:outline-pink-500 bg-white px-3 py-2 ml-2 rounded-full mb-2' type="text" placeholder='Enter your description' />
